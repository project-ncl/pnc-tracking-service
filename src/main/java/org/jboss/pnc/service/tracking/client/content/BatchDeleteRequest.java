...
@Schema(
        description = "Request of batch files that will be removed from the repository. Specifying the folo"
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        if (batchDeleteRequestVersion > BATCH_DELETE_REQUEST_VERSION) {
            throw new IOException(
                    "Cannot deserialize. BatchDeleteRequest version in data stream is: " + batchDeleteRequestVersion
