 ...
 */
package org.jboss.pnc.service.tracking.data.metrics;

import static org.apache.commons.lang3.StringUtils.isBlank;
import static org.jboss.pnc.service.tracking.data.metrics.TraceManager.DEFAULT;
...
public class NameUtils {
    ...
    /**
     * Get default metric name. Experience has shown that we don't need to include all of the package details for each
     * method metric we're gathering. The class names are unique enough to be useful without this. We need to migrate to
     * an easier format: <short-class-name>.<method-or-alias>.<metric-type>
     */
